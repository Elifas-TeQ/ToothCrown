...
using Coins.IssueManagementForContract.Common.Utils.VisibilityEffectOnScrollDeterminator;
using Moq;
using NUnit.Framework;
using Xamarin.Forms;
using Determinator = Coins.IssueManagementForContract.Common.Utils.VisibilityEffectOnScrollDeterminator.VisibilityEffectOnScrollDeterminator;

namespace Coins.IssueManagementForContract.UnitTest.Common.Utils.VisibilityEffectOnScrollDeterminator
{
    [TestFixture]
